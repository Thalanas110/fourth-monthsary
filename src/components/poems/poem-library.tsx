    ...
    <section className="library-section" id="library" aria-labelledby="library-title">
      <div className="library-inner">
        <div className="section-head">
          <div><div className="eyebrow">The lantern room &middot; 07 pieces</div><h2 className="section-title" id="library-title">What are you carrying?</h2></div>
          <p className="section-note">Seven poems.<br />Take the one that glows.</p>
        </div>
